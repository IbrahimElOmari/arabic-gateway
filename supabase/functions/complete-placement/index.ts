...
serve(async (req: Request) => {
  const logger = createLogger("complete-placement", req);
  ...
  try {
    ...
    logger.error("Complete placement error", { error: error instanceof Error ? error.message : String(error), stack: error instanceof Error ? error.stack : undefined });
