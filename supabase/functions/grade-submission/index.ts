...
serve(async (req: Request) => {
  const logger = createLogger("grade-submission", req);
  ...
  try {
    ...
    logger.error("Grade submission error", { error: error instanceof Error ? error.message : String(error), stack: error instanceof Error ? error.stack : undefined });
