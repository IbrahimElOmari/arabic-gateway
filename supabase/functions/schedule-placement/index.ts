...
serve(async (req: Request) => {
  const logger = createLogger("schedule-placement", req);
  ...
  try {
    ...
    logger.error("Schedule placement error", { error: error instanceof Error ? error.message : String(error), stack: error instanceof Error ? error.stack : undefined });
