...
serve(async (req: Request) => {
  const logger = createLogger("release-exercises", req);
  ...
  try {
    ...
    logger.error("Release exercises error", { error: error instanceof Error ? error.message : String(error), stack: error instanceof Error ? error.stack : undefined });
